...
<!-- video screengrab -->
<td rowspan="4" class="cq-logo-td"><?php print $row['field_image']; ?></td>

<!-- description additional info and link row -->
<td class="cq-desc-fst-td"><b><?php print $row['field_award_date']; ?></b>
...
<tr>
<td class="cq-desc-lst-td"><?php print $row['field_award_url']; ?>
</tr>
